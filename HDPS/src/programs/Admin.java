...
import programs.com.prediction.heart.*;
import javax.swing.*;
...
public class Admin extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Pulse Rate/Heart Rate");
        ...
        jLabel7.setText("Consumption cigarette for year");
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Normal", "Abnormal" }));
        ...
        jLabel13.setText("Cigarette Consume per day");
        ...
        jLabel14.setText("Rest ECG");

        jLabel15.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Alcohol Consume");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        double age, gender, chestpain, cigratte, cigratteyear, restecg, hp, lp, colestrol, pulserate,
                familyhis, alcohol;
        double value;
        hp = Double.parseDouble(jTextField1.getText());
        
        lp = Double.parseDouble(jTextField2.getText());
        pulserate = Double.parseDouble(jTextField3.getText());
        age = Double.parseDouble(jTextField4.getText());
        colestrol = Double.parseDouble(jTextField5.getText());
        cigratte = Double.parseDouble(jTextField6.getText());
        if ("Male".equals(jComboBox1.getItemAt(jComboBox1.getSelectedIndex()))) {
            value = 1;
        } else {
            value = 0;
        }
        gender = value;
        String cigyear = jComboBox2.getItemAt(jComboBox2.getSelectedIndex());
        cigratteyear = Double.parseDouble(cigyear);
        if ("Yes".equals(jComboBox3.getItemAt(jComboBox3.getSelectedIndex()))) {
            value = 1;
        } else {
            value = 0;
        }
        ...
        if ("Yes".equals(jComboBox4.getItemAt(jComboBox4.getSelectedIndex()))) {
            value = 1;
        } else {
            value = 0;
        }
        ...
        if ("Normal".equals(jComboBox5.getItemAt(jComboBox5.getSelectedIndex()))) {
            value = 0;
        } else {
            value = 1;
        }
        ...
        if ("Yes".equals(jComboBox6.getItemAt(jComboBox6.getSelectedIndex()))) {
            value = 1;
        } else {
            value = 0;
        }
        ...
        dispose();
        Process1 process1;
        process1 = new Process1(age, gender, chestpain,
                          cigratte, cigratteyear, restecg, hp, lp,
                          pulserate, colestrol, familyhis, alcohol);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        admin.setSize(900, 640);
        admin.setResizable(false);
        admin.setLocationRelativeTo(null);    }//GEN-LAST:event_jButton3ActionPerformed
    ...
    private void alert(String hello_magar) {

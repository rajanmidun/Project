package programs.com.prediction.heart.nb;
...
import programs.com.prediction.heart.QuestionType;
import programs.com.prediction.heart.entities.Investigation;
import programs.com.prediction.heart.Util;
...
public class NaiveBayesClassifier {
    ...
    public static NaiveBayes train(String dataFile, String modelFile) throws Exception {
        try {
            ...
            //class for evaluating the maching learning model
...
//            }
    ...
    public static String medicalBot(String modelFile, Map<QuestionType, Double> parameters) {
        try {
            ...
            Attribute cpAttr = new Attribute("chest pain");
            Attribute cigsAttr = new Attribute("cigs");
            Attribute cholAttr = new Attribute("chol");
            ...
            Attribute alchAttr = new Attribute("alc");
...
//            BufferedWriter writer = new BufferedWriter(new FileWriter("patientData.txt"));
//            for(int i=0;i<fvAttributes.size();i++)
//                writer.write(fvAttributes.get(0).value(i));
//            writer.close();
//            DataSource source= new DataSource("patientData.txt");
//            Instances instances=source.getDataSet();
            Instances instances = new Instances("Rajan", fvAttributes, 1);
            instances.setClassIndex(numAttributes - 1);

            // Create empty instance with 13(numAttributes) attribute values
            ...
            for (Map.Entry<QuestionType, Double> entry
                ...
                // Set instance's values for the attributes "all 13 attribues"
            ...
            if (index
                    == 0) {
                resulte = "Congratulations there is no possibility"
